...
public class StartHatGameDialogueManager : MonoBehaviour
{
    ...
    {
        if(dr.Dialogue.CurrentNode == "StartDashGame")
        {
            dialogueOpen = false;
            GameObject.Find("GameManager").GetComponent<GameManager>().StartHatGame("DashGame");
        }
        else GiveMovement();
    }
