...
public class StartGameDialogueManager : MonoBehaviour
{
    ...
    {
        if(dr.Dialogue.CurrentNode == "StartGame")
        {
            dialogueOpen = false;
            GameObject.Find("GameManager").GetComponent<GameManager>().StartPianoTilesGame("IntroGame");
        }
        else GiveMovement();
    }
